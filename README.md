...
| ADDON-002 | High-impact add-on compatibility could not be verified (VPC CNI, kube-proxy, CoreDNS, EBS/EFS CSI) | `eks:DescribeAddonVersions` | Warning | `PROVIDER_REPORTED` |
