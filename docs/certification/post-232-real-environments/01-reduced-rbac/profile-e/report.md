...
| **Scanned at** | 2026-07-29 09:18:45 UTC |
| **Result** | **INCOMPLETE** |
...
- Kubernetes: apiservices [permission-denied,permissionDenied,partialDataPreserved]: apiservices.apiregistration.k8s.io is forbidden: User "system:serviceaccount:default:kp-cert-e" cannot list resource "apiservices" in API group "apiregistration.k8s.io" at the cluster scope
- Kubernetes: deprecated-api:apiregistration.k8s.io/v1beta1, Resource=apiservices [permission-denied,permissionDenied,partialDataPreserved]: apiservices.apiregistration.k8s.io is forbidden: User "system:serviceaccount:default:kp-cert-e" cannot list resource "apiservices" in API group "apiregistration.k8s.io" at the cluster scope
