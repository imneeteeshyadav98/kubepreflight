...
| **Scanned at** | 2026-07-29 09:18:43 UTC |
| **Result** | **INCOMPLETE** |
...
- Kubernetes: deprecated-api:discovery.k8s.io/v1beta1, Resource=endpointslices [permission-denied,permissionDenied,partialDataPreserved]: endpointslices.discovery.k8s.io is forbidden: User "system:serviceaccount:default:kp-cert-c" cannot list resource "endpointslices" in API group "discovery.k8s.io" at the cluster scope
- Kubernetes: endpointslices [permission-denied,permissionDenied,partialDataPreserved]: endpointslices.discovery.k8s.io is forbidden: User "system:serviceaccount:default:kp-cert-c" cannot list resource "endpointslices" in API group "discovery.k8s.io" at the cluster scope
- Kubernetes: services [permission-denied,permissionDenied,partialDataPreserved]: services is forbidden: User "system:serviceaccount:default:kp-cert-c" cannot list resource "services" in API group "" at the cluster scope
