...
| **Scanned at** | 2026-07-29 09:18:46 UTC |
| **Result** | **INCOMPLETE** |
...
- Kubernetes: pods [permission-denied,permissionDenied,partialDataPreserved]: pods is forbidden: User "system:serviceaccount:default:kp-cert-f" cannot list resource "pods" in API group "" at the cluster scope
...
>
> **Advisory:** 6 applicable rules were not fully evaluated; evidence collection was incomplete for: Kubernetes. Review before approving the change.
...
| `DRAIN-001` | Applicable | Insufficient evidence | Unable to verify | required collector data was unavailable for: kubernetes:pods |
| `DRAIN-002` | Applicable | Insufficient evidence | Unable to verify | required collector data was unavailable for: kubernetes:pods |
| `DRAIN-003` | Applicable | Insufficient evidence | Unable to verify | required collector data was unavailable for: kubernetes:pods |
...
| `PDB-002` | Applicable | Insufficient evidence | Unable to verify | required collector data was unavailable for: kubernetes:pods |
