...
| 5 | 13.5s – 16.0s | The real, sanitized `report.html`, with a bottom-bar caption "CLI · JSON · Markdown · HTML" | `evidence/scan-report.html`, served live | **Real page**, live navigation |
